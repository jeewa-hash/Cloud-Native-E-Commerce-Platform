...
const AUTH_ALB = "http://auth-alb-1706945340.eu-north-1.elb.amazonaws.com";
const SHOP_ALB = "http://shop-alb-1163828963.eu-north-1.elb.amazonaws.com";
...
const PROD = {
  ...
  SHOP_API: `${SHOP_ALB}/shop/api`,
  ORDER_API: `${API_GATEWAY}/order/api`,
  NOTIFICATION_SERVICE_URL: `${API_GATEWAY}/notification`,
  PRODUCTS_API: `${API_GATEWAY}/order/api`
};
