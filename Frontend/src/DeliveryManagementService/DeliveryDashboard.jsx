...
const DeliveryDashboard = ({ profile }) => {
  ...
  const renderContent = () => {
    switch (activeTab) {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                You can manage your shipments, update your profile, and control your availability from here.
              </p>
            </div>
          </div>
        );
      ...
      case "shipments":
        return <div>Shipment list goes here</div>;

      case "profile":
        return <div>Profile details/edit form goes here</div>;

      case "availability":
        return <div>Availability update section goes here</div>;
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside
        className={`fixed lg:sticky top-0 left-0 z-30 h-screen w-72 bg-white border-r border-gray-200 
